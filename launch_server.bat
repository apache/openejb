...
REM 
set OPENEJB_OPTION_3= -Dtest.server.class=org.openejb.test.CorbaTestServer

REM #####################################
REM  startup options      
REM         
REM set OPTIONS=%OPENEJB_OPTION_X% %OPENEJB_OPTION_1% %OPENEJB_OPTION_2% %OPENORB_OPTIONS%
set OPTIONS=%OPENEJB_OPTION_X%  %OPENEJB_OPTION_1% %OPENEJB_OPTION_2% %OPENORB_OPTIONS%
...
%JAVA% %OPTIONS% -classpath %CP% org.openejb.corba.Server conf\xopenejb_startup.props -ORBProfile=ejb -domain conf\tyrex_resources.xml
