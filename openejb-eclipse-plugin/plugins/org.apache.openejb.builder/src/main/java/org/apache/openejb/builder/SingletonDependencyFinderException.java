...
public class SingletonDependencyFinderException extends Exception {
	...
	public SingletonDependencyFinderException(String message, Throwable throwable) {
		super(message, throwable);
	}

	public SingletonDependencyFinderException(String message) {
		super(message);
	}

	public SingletonDependencyFinderException(Throwable throwable) {
		super(throwable);
	}
