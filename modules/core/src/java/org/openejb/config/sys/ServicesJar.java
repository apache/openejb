...
public class ServicesJar implements java.io.Serializable {
     ...
     */
    public void addServiceProvider(org.openejb.config.sys.ServiceProvider vServiceProvider)
     ...
     * @param vServiceProvider
     */
    public void addServiceProvider(int index, org.openejb.config.sys.ServiceProvider vServiceProvider)
            throws java.lang.IndexOutOfBoundsException {
     ...
     * @param index
     */
    public org.openejb.config.sys.ServiceProvider getServiceProvider(int index)
            throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.openejb.config.sys.ServiceProvider) _serviceProviderList.elementAt(index);
    } //-- org.openejb.config.sys.ServiceProvider getServiceProvider(int) 

    /**
     * Method getServiceProvider
     */
    public org.openejb.config.sys.ServiceProvider[] getServiceProvider() {
        int size = _serviceProviderList.size();
        org.openejb.config.sys.ServiceProvider[] mArray = new org.openejb.config.sys.ServiceProvider[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.openejb.config.sys.ServiceProvider) _serviceProviderList.elementAt(index);
        }
        return mArray;
     ...
     * @param index
     */
    public org.openejb.config.sys.ServiceProvider removeServiceProvider(int index) {
        java.lang.Object obj = _serviceProviderList.elementAt(index);
        _serviceProviderList.removeElementAt(index);
        return (org.openejb.config.sys.ServiceProvider) obj;
     ...
     * @param vServiceProvider
     */
    public void setServiceProvider(int index, org.openejb.config.sys.ServiceProvider vServiceProvider)
            throws java.lang.IndexOutOfBoundsException {
        //-- check bounds for index
        if ((index < 0) || (index > _serviceProviderList.size())) {
            throw new IndexOutOfBoundsException();
     ...
     */
    public void setServiceProvider(org.openejb.config.sys.ServiceProvider[] serviceProviderArray) {
        //-- copy array
        _serviceProviderList.removeAllElements();
    ...
    public static java.lang.Object unmarshal(java.io.Reader reader)
            throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.openejb.config.sys.ServicesJar) Unmarshaller.unmarshal(org.openejb.config.sys.ServicesJar.class, reader);
