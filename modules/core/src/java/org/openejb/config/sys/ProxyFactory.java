...
**/
public class ProxyFactory implements java.io.Serializable, org.openejb.config.Service {
    ...
    **/
    ...
    public ProxyFactory() {
        super();
    } //-- org.openejb.config.sys.ProxyFactory()
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.sys.ProxyFactory unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.openejb.config.sys.ProxyFactory) Unmarshaller.unmarshal(org.openejb.config.sys.ProxyFactory.class, reader);
    } //-- org.openejb.config.sys.ProxyFactory unmarshal(java.io.Reader) 
