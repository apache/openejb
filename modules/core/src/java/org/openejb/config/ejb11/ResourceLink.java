...
public class ResourceLink implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.ejb11.ResourceLink unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.openejb.config.ejb11.ResourceLink) Unmarshaller.unmarshal(org.openejb.config.ejb11.ResourceLink.class, reader);
    } //-- org.openejb.config.ejb11.ResourceLink unmarshal(java.io.Reader) 
