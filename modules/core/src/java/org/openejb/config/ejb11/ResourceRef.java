...
public class ResourceRef implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.ejb11.ResourceRef unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.openejb.config.ejb11.ResourceRef) Unmarshaller.unmarshal(org.openejb.config.ejb11.ResourceRef.class, reader);
    } //-- org.openejb.config.ejb11.ResourceRef unmarshal(java.io.Reader) 
