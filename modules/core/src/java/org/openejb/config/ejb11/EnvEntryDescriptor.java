...
public class EnvEntryDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public EnvEntryDescriptor() {
        ...
        //-- _envEntryName
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_envEntryName", "env-entry-name", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
        ...
        //-- validation code for: _envEntryName
        fieldValidator = new FieldValidator();
        ...
        //-- _envEntryType
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_envEntryType", "env-entry-type", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
        ...
        //-- validation code for: _envEntryType
        fieldValidator = new FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
            StringValidator sv = new StringValidator();
        ...
        //-- _envEntryValue
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_envEntryValue", "env-entry-value", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
        ...
        //-- validation code for: _envEntryValue
        fieldValidator = new FieldValidator();
        { //-- local scope
            StringValidator sv = new StringValidator();
            sv.setWhiteSpace("preserve");
    ...
    } //-- org.openejb.config.ejb11.EnvEntryDescriptor()
    ...
    **/
    ...
    {
        return org.openejb.config.ejb11.EnvEntry.class;
