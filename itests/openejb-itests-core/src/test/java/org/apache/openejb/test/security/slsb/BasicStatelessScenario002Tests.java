 ...
 */
public class BasicStatelessScenario002Tests extends BasicStatelessTestClient {

    public BasicStatelessScenario002Tests() {
        super("BasicStatelessScenario002.");
    }

    public void testUnassigned() throws Exception {
        Object obj = initialContext.lookup("security/002/BasicStatelessHome");
