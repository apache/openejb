    ...
    public void lookupEntityBean() throws TestFailureException {
        try {
            try {
                ...
                BasicCmpHome home = (BasicCmpHome) PortableRemoteObject.narrow(ctx.lookup("java:comp/env/entity/cmp/beanReferences/cmp_entity"), BasicCmpHome.class);
    ...
    public void lookupStatefulBean() throws TestFailureException {
        try {
            try {
                ...
                BasicStatefulHome home = (BasicStatefulHome) PortableRemoteObject.narrow(ctx.lookup("java:comp/env/entity/cmp/beanReferences/stateful"), BasicStatefulHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
    ...
    public void lookupStatelessBean() throws TestFailureException {
        try {
            try {
                ...
                BasicStatelessHome home = (BasicStatelessHome) PortableRemoteObject.narrow(ctx.lookup("java:comp/env/entity/cmp/beanReferences/stateless"), BasicStatelessHome.class);
                Assert.assertNotNull("The EJBHome looked up is null", home);
