...
package org.apache.openejb.maven.plugin.table;
...
public class Line {
    ...
    public void print(final int[] max, final Log out) {
        print(max, out, false);
    }

    public void print(final int[] max, final Log out, boolean header) {
    ...
    private static void printLine(final Log out, final String s) {
        out.info(s);
    }
}
