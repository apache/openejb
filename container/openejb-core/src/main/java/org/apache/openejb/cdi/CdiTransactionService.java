...
public class CdiTransactionService implements TransactionService {
    
    private static final Logger logger = Logger.getInstance(LogCategory.OPENEJB.createChild("cdi"), CdiTransactionService.class);
    
    public CdiTransactionService() {
