...
public final class EjbTransactionUtil {
     ...
     */
    public static void afterInvoke(TransactionPolicy txPolicy, TransactionContext txContext) throws SystemException, ApplicationException {
        txPolicy.resumeTransaction(txContext, txContext.clientTx);
    }
