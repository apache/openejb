...
:DEPLOY 
   shift
   java -cp dist/openejb-1.0.jar org.openejb.util.Launcher org.openejb.alt.config.Deploy %1 %2 %3 %4 %5 %6 %7 %8 %9
...
:STOP_SERVER
   shift
   java -cp dist/openejb-1.0.jar org.openejb.util.Launcher org.openejb.server.Stop %1 %2 %3 %4 %5 %6 %7 %8 %9
...
:CORBA
   ...
   start "OpenORB JNDI Server" java -cp dist/openejb-1.0.jar org.openejb.util.Launcher %NAMING_OPTIONS% org.openorb.util.MapNamingContext -ORBPort=2001 -print
   ...
   java -cp dist/openejb-1.0.jar org.openejb.util.Launcher %SERVER_OPTIONS% %OPENORB_OPTIONS% org.openejb.corba.Server -ORBProfile=ejb -domain conf\tyrex_resources.xml
...
:TEST_CORBA
   ...
   start "OpenORB JNDI Server" java -cp dist/openejb-1.0.jar org.openejb.util.Launcher %NAMING_OPTIONS% org.openorb.util.MapNamingContext -ORBPort=2001 -default
   ...
   start "OpenEJB RMI/IIOP Server" java -cp dist/openejb-1.0.jar org.openejb.util.Launcher %SERVER_OPTIONS% %OPENORB_OPTIONS% org.openejb.corba.Server -ORBProfile=ejb -domain conf\tyrex_resources.xml
...
:CREATE_STUBS
   ...
   java -cp dist/openejb-1.0.jar org.openejb.util.Launcher %OPTIONS% org.openorb.rmi.compiler.JavaToIdl %JAVATOIDL_OPTS% %1 %2 %3 %4 %5 %6 %7 %8 %9
