...
/**
 * Interface definition : Database
 * 
 * @author OpenORB Compiler
 */

public class _Database_Stub extends javax.rmi.CORBA.Stub
		implements Database
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.beans.Database:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = Database.class;

	//
	// Operation executeQuery
	//
	public void executeQuery(String arg0)
		throws java.rmi.RemoteException
	{
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					org.omg.CORBA_2_3.portable.OutputStream _output = ( org.omg.CORBA_2_3.portable.OutputStream ) this._request("executeQuery",true);
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.beans.Database)_so.servant).executeQuery( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBHome _arg_ret = ((org.openejb.test.beans.Database)_so.servant).getEJBHome();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.Handle _arg_ret = ((org.openejb.test.beans.Database)_so.servant).getHandle();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.lang.Object _arg_ret = ((org.openejb.test.beans.Database)_so.servant).getPrimaryKey();
		...
		throws javax.ejb.RemoveException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.beans.Database)_so.servant).remove();
					return;
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					boolean _arg_ret = ((org.openejb.test.beans.Database)_so.servant).isIdentical( arg0Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
