...
public class _EmployeeHome_Stub extends javax.rmi.CORBA.Stub
		implements EmployeeHome
{
	...
	final public static java.lang.Class _opsClass = EmployeeHome.class;

	//
	// Operation create
	//
	public org.openejb.test.beans.Employee create(String arg0, String arg1)
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					_output.write_value((java.io.Serializable)arg1,String.class);
					_input = ( org.omg.CORBA_2_3.portable.InputStream ) this._invoke(_output);
					org.openejb.test.beans.Employee _arg_ret = ( org.openejb.test.beans.Employee ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.beans.Employee.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					...
					String arg1Copy = (String)javax.rmi.CORBA.Util.copyObject(arg1, _orb());
					org.openejb.test.beans.Employee _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).create( arg0Copy,  arg1Copy);
					return (org.openejb.test.beans.Employee)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					int arg0Copy = arg0;
					int arg1Copy = arg1;
					int _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).sum( arg0Copy,  arg1Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
		...
		throws javax.ejb.FinderException, java.rmi.RemoteException
	{
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					org.omg.CORBA_2_3.portable.OutputStream _output = ( org.omg.CORBA_2_3.portable.OutputStream ) this._request("findAll",true);
					_input = ( org.omg.CORBA_2_3.portable.InputStream ) this._invoke(_output);
			...
			{
				org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke("findAll",_opsClass);
				if ( _so == null )
				   return findAll();
				try
				{
					java.util.Collection _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).findAll();
	...
	//
	public org.openejb.test.beans.Employee findByPrimaryKey(java.lang.Integer arg0)
		throws javax.ejb.FinderException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.beans.Employee _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).findByPrimaryKey( arg0Copy);
					return (org.openejb.test.beans.Employee)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.beans.EmployeeHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.beans.EmployeeHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
