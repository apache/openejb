...
public class _ShoppingCartHome_Stub extends javax.rmi.CORBA.Stub
		implements ShoppingCartHome
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.beans.ShoppingCartHome:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = ShoppingCartHome.class;

	//
	// Operation create
	//
	public org.openejb.test.beans.ShoppingCart create(String arg0)
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					org.openejb.test.beans.ShoppingCart _arg_ret = ( org.openejb.test.beans.ShoppingCart ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.beans.ShoppingCart.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.beans.ShoppingCart _arg_ret = ((org.openejb.test.beans.ShoppingCartHome)_so.servant).create( arg0Copy);
					return (org.openejb.test.beans.ShoppingCart)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.beans.ShoppingCartHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.beans.ShoppingCartHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.beans.ShoppingCartHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
