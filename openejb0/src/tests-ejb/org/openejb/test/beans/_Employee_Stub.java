		...
		implements Employee
{
	...
	//
	public void  setFirstName(java.lang.String arg )
		throws java.rmi.RemoteException
	{
		while( true )
		{
				...
				try
				{
					org.omg.CORBA_2_3.portable.OutputStream _output = ( org.omg.CORBA_2_3.portable.OutputStream ) this._request("_set_firstName",false);
	...
	//
	public void  setLastName(java.lang.String arg )
		throws java.rmi.RemoteException
	{
		while( true )
		{
				...
				try
				{
					org.omg.CORBA_2_3.portable.OutputStream _output = ( org.omg.CORBA_2_3.portable.OutputStream ) this._request("_set_lastName",false);
					_output.write_value((java.io.Serializable)arg,java.lang.String.class);
					_input = ( org.omg.CORBA_2_3.portable.InputStream ) this._invoke(_output);
					return;
				}
