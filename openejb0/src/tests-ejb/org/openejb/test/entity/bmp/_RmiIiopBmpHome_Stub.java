...
/**
 * Interface definition : RmiIiopBmpHome
 * 
 * @author OpenORB Compiler
 */

public class _RmiIiopBmpHome_Stub extends javax.rmi.CORBA.Stub
		implements RmiIiopBmpHome
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.entity.bmp.RmiIiopBmpHome:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = RmiIiopBmpHome.class;

	//
	// Operation create
	//
	public org.openejb.test.entity.bmp.RmiIiopBmpObject create(String arg0)
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.RmiIiopBmpObject _arg_ret = ( org.openejb.test.entity.bmp.RmiIiopBmpObject ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.entity.bmp.RmiIiopBmpObject.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.RmiIiopBmpObject _arg_ret = ((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).create( arg0Copy);
					return (org.openejb.test.entity.bmp.RmiIiopBmpObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
	...
	//
	public org.openejb.test.entity.bmp.RmiIiopBmpObject findByPrimaryKey(java.lang.Integer arg0)
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.RmiIiopBmpObject _arg_ret = ((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).findByPrimaryKey( arg0Copy);
					return (org.openejb.test.entity.bmp.RmiIiopBmpObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws javax.ejb.FinderException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.util.Collection _arg_ret = ((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).findEmptyCollection();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.entity.bmp.RmiIiopBmpHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
