...
/**
 * Interface definition : BasicBmpHome
 * 
 * @author OpenORB Compiler
 */

public class _BasicBmpHome_Stub extends javax.rmi.CORBA.Stub
		implements BasicBmpHome
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.entity.bmp.BasicBmpHome:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = BasicBmpHome.class;

	//
	// Operation create
	//
	public org.openejb.test.entity.bmp.BasicBmpObject create(String arg0)
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.BasicBmpObject _arg_ret = ( org.openejb.test.entity.bmp.BasicBmpObject ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.entity.bmp.BasicBmpObject.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.BasicBmpObject _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).create( arg0Copy);
					return (org.openejb.test.entity.bmp.BasicBmpObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
	...
	//
	public org.openejb.test.entity.bmp.BasicBmpObject findByPrimaryKey(java.lang.Integer arg0)
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.BasicBmpObject _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).findByPrimaryKey( arg0Copy);
					return (org.openejb.test.entity.bmp.BasicBmpObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws javax.ejb.FinderException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.util.Collection _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).findEmptyCollection();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					int arg0Copy = arg0;
					int arg1Copy = arg1;
					int _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).sum( arg0Copy,  arg1Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.entity.bmp.BasicBmpHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
