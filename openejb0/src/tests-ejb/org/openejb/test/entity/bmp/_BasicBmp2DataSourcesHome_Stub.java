		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.BasicBmp2DataSourcesObject _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).create( arg0Copy);
					return (org.openejb.test.entity.bmp.BasicBmp2DataSourcesObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.entity.bmp.BasicBmp2DataSourcesObject _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).findByPrimaryKey( arg0Copy);
					return (org.openejb.test.entity.bmp.BasicBmp2DataSourcesObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws javax.ejb.FinderException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.util.Collection _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).findEmptyCollection();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					int arg0Copy = arg0;
					int arg1Copy = arg1;
					int _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).sum( arg0Copy,  arg1Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.entity.bmp.BasicBmp2DataSourcesHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
