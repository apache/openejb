...
//
public class _EncCmpHome_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.entity.cmp.EncCmpHome target;
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String opName, org.omg.CORBA.portable.InputStream _is, org.omg.CORBA.portable.ResponseHandler handler)
	{
		...
		try
		{
			if ( opName.equals("create") )
			{
				...
				try
				{
					org.openejb.test.entity.cmp.EncCmpObject _arg_result = target.create(arg0_in);
			...
			if ( opName.equals("findByPrimaryKey") )
			{
				...
				try
				{
					org.openejb.test.entity.cmp.EncCmpObject _arg_result = target.findByPrimaryKey(arg0_in);
