...
public class _RmiIiopCmpHome_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.entity.cmp.RmiIiopCmpHome target;
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String opName, org.omg.CORBA.portable.InputStream is, org.omg.CORBA.portable.ResponseHandler handler)
	{
		...
		try
		{
			if ( opName.equals("create") )
			{
				...
				try
				{
					org.openejb.test.entity.cmp.RmiIiopCmpObject _arg_result = target.create(arg0_in);
			...
			if ( opName.equals("findByPrimaryKey") )
			{
				...
				try
				{
					org.openejb.test.entity.cmp.RmiIiopCmpObject _arg_result = target.findByPrimaryKey(arg0_in);
