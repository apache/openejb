...
/**
 * Interface definition : EncStatefulObject
 * 
 * @author OpenORB Compiler
 */

public class _EncStatefulObject_Stub extends javax.rmi.CORBA.Stub
		implements EncStatefulObject
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.stateful.EncStatefulObject:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = EncStatefulObject.class;
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupEntityBean();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupStatefulBean();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupStatelessBean();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupResource();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupStringEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupDoubleEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupLongEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupFloatEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupIntegerEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupShortEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupBooleanEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws org.openejb.test.TestFailureException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).lookupByteEntry();
					return;
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBHome _arg_ret = ((org.openejb.test.stateful.EncStatefulObject)_so.servant).getEJBHome();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.Handle _arg_ret = ((org.openejb.test.stateful.EncStatefulObject)_so.servant).getHandle();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.lang.Object _arg_ret = ((org.openejb.test.stateful.EncStatefulObject)_so.servant).getPrimaryKey();
		...
		throws javax.ejb.RemoveException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.EncStatefulObject)_so.servant).remove();
					return;
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					boolean _arg_ret = ((org.openejb.test.stateful.EncStatefulObject)_so.servant).isIdentical( arg0Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
