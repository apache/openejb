...
//
public class _EncStatefulHome_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateful.EncStatefulHome target;
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String opName, org.omg.CORBA.portable.InputStream _is, org.omg.CORBA.portable.ResponseHandler handler)
	{
		...
		try
		{
			if ( opName.equals("create") )
			{
				...
				try
				{
					org.openejb.test.stateful.EncStatefulObject _arg_result = target.create(arg0_in);
