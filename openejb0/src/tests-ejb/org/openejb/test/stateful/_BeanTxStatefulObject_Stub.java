		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					org.openejb.test.object.Transaction _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).getUserTransaction();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					org.openejb.test.object.Transaction _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).jndiUserTransaction();
					return (org.openejb.test.object.Transaction)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).openAccount( arg0Copy,  arg1Copy);
					return;
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.object.Account _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).retreiveAccount( arg0Copy);
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBHome _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).getEJBHome();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.Handle _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).getHandle();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					java.lang.Object _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).getPrimaryKey();
		...
		throws javax.ejb.RemoveException, java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).remove();
					return;
				}
				catch ( Throwable ex )
				{
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					boolean _arg_ret = ((org.openejb.test.stateful.BeanTxStatefulObject)_so.servant).isIdentical( arg0Copy);
					return _arg_ret;
				}
				catch ( Throwable ex )
				{
