...
public class _BasicStatefulHome_Stub extends javax.rmi.CORBA.Stub
		implements BasicStatefulHome
{
	...
	final public static java.lang.Class _opsClass = BasicStatefulHome.class;

	//
	// Operation create
	//
	public org.openejb.test.stateful.BasicStatefulObject create(String arg0)
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					org.openejb.test.stateful.BasicStatefulObject _arg_ret = ( org.openejb.test.stateful.BasicStatefulObject ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.stateful.BasicStatefulObject.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					...
					org.openejb.test.stateful.BasicStatefulObject _arg_ret = ((org.openejb.test.stateful.BasicStatefulHome)_so.servant).create( arg0Copy);
					return (org.openejb.test.stateful.BasicStatefulObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.stateful.BasicStatefulHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.stateful.BasicStatefulHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.stateful.BasicStatefulHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
