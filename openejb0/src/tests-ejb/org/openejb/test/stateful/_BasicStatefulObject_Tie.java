...
//
public class _BasicStatefulObject_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateful.BasicStatefulObject target;
	...
	{
		target = (BasicStatefulObject) targ;
	}
