...
//
public class _BeanTxStatelessHome_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateless.BeanTxStatelessHome target;
	...
	{
		target = (BeanTxStatelessHome) targ;
	}
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String opName, org.omg.CORBA.portable.InputStream _is, org.omg.CORBA.portable.ResponseHandler handler)
	{
		...
		try
		{
			if ( opName.equals("create") )
			{
				...
				try
				{
					org.openejb.test.stateless.BeanTxStatelessObject _arg_result = target.create();
				...
				{
					String exid = "RMI:javax.ejb.CreateException:000000000075D6AB:0000000000000000";
			...
			if ( opName.equals("remove__javax_ejb_Handle") )
			{
				...
				{
					String exid = "RMI:javax.ejb.RemoveException:00000000005253D5:0000000000000000";
					_output = ( org.omg.CORBA_2_3.portable.OutputStream ) handler.createExceptionReply();
					_output.write_string(exid);
					_output.write_value(_exception);
				}
