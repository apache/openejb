...
public class _RmiIiopStatelessObject_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateless.RmiIiopStatelessObject target;
	...
	{
		target = (RmiIiopStatelessObject) targ;
	}
