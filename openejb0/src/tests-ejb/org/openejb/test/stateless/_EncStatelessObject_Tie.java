...
//
public class _EncStatelessObject_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateless.EncStatelessObject target;
	...
	{
		target = (EncStatelessObject) targ;
	}
