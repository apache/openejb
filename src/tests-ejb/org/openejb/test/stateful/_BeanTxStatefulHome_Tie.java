...
//
public class _BeanTxStatefulHome_Tie extends org.omg.PortableServer.Servant
		implements javax.rmi.CORBA.Tie
{
	...
	//
	private org.openejb.test.stateful.BeanTxStatefulHome target;
	...
	{
		target = (BeanTxStatefulHome) targ;
	}
	...
	public org.omg.CORBA.portable.OutputStream _invoke(String opName, org.omg.CORBA.portable.InputStream _is, org.omg.CORBA.portable.ResponseHandler handler)
	{
		...
		try
		{
			if ( opName.equals("create") )
			{
				...
				try
				{
					org.openejb.test.stateful.BeanTxStatefulObject _arg_result = target.create(arg0_in);
				...
				{
					String exid = "RMI:javax.ejb.CreateException:0000000000093EFE:0000000000000000";
