...
/**
 * Interface definition : BasicStatelessHome
 * 
 * @author OpenORB Compiler
 */

public class _BasicStatelessHome_Stub extends javax.rmi.CORBA.Stub
		implements BasicStatelessHome
{

	static final String[] _ids_list =
	{
		"RMI:org.openejb.test.stateless.BasicStatelessHome:0000000000000000", 
	...
	final public static java.lang.Class _opsClass = BasicStatelessHome.class;

	//
	// Operation create
	//
	public org.openejb.test.stateless.BasicStatelessObject create()
		...
		while( true )
		{
			if (!javax.rmi.CORBA.Util.isLocal(this) )
			{
				...
				try
				{
					...
					org.openejb.test.stateless.BasicStatelessObject _arg_ret = ( org.openejb.test.stateless.BasicStatelessObject ) javax.rmi.PortableRemoteObject.narrow(_input.read_Object(), org.openejb.test.stateless.BasicStatelessObject.class);
					return _arg_ret;
				}
			...
			else
			{
				...
				try
				{
					org.openejb.test.stateless.BasicStatelessObject _arg_ret = ((org.openejb.test.stateless.BasicStatelessHome)_so.servant).create();
					return (org.openejb.test.stateless.BasicStatelessObject)javax.rmi.CORBA.Util.copyObject(_arg_ret, _orb());
				}
				catch ( Throwable ex )
				{
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.EJBMetaData _arg_ret = ((org.openejb.test.stateless.BasicStatelessHome)_so.servant).getEJBMetaData();
		...
		throws java.rmi.RemoteException
	{
		while( true )
		{
			...
			else
			{
				...
				try
				{
					javax.ejb.HomeHandle _arg_ret = ((org.openejb.test.stateless.BasicStatelessHome)_so.servant).getHomeHandle();
		...
		while( true )
		{
			...
			else
			{
				...
				try
				{
					...
					((org.openejb.test.stateless.BasicStatelessHome)_so.servant).remove( arg0Copy);
					return;
				}
				catch ( Throwable ex )
				{
