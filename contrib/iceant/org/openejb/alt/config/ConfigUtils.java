...
public class ConfigUtils {
    ...
    /** Delete directory which include sub directories. */
    public static void deleteTree(String _file){
        try {
    ...
    /** Copy archive file */
    public static void copyZipFile(String src,String dest){
    	try{
	    ZipHandle    srcHdl = ZipTool.open(src);
	    ZipHandle    dstHdl = ZipTool.create(dest);
