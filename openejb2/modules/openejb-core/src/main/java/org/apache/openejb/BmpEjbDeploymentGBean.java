 ...
 */
public final class BmpEjbDeploymentGBean {

    public static final GBeanInfo GBEAN_INFO;

    static {
        GBeanInfoBuilder infoFactory = GBeanInfoBuilder.createStatic(BmpEjbDeploymentGBean.class, BmpEjbDeployment.class, NameFactory.ENTITY_BEAN);
        ...
        infoFactory.addReference("ejbContainer", BmpEjbContainer.class, "EntityEjbContainer");
        ...
        infoFactory.addInterface(BmpEjbDeployment.class);
