...
<head>
    ...
    <!-- $Id: viewejb.jsp 444624 2004-03-01 07:17:26Z dblevins $ -->
...
<%!
    ...
    public void printEjb(String name, javax.servlet.jsp.JspWriter out, HttpSession session) throws Exception {
        ...
        org.apache.openejb.DeploymentInfo ejb = org.apache.openejb.OpenEJB.getDeploymentInfo(id);
        ...
        switch (ejb.getComponentType()) {
            case org.apache.openejb.core.DeploymentInfo.CMP_ENTITY :
                type = "EntityBean with Container-Managed Persistence";
                break;
            case org.apache.openejb.core.DeploymentInfo.BMP_ENTITY :
                type = "EntityBean with Bean-Managed Persistence";
                break;
            case org.apache.openejb.core.DeploymentInfo.STATEFUL :
                type = "Stateful SessionBean";
                break;
            case org.apache.openejb.core.DeploymentInfo.STATELESS :
        ...
        Context enc = ((org.apache.openejb.core.DeploymentInfo)ejb).getJndiEnc();
