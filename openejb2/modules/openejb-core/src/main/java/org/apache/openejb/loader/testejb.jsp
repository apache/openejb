...
<%!
    ...
    public void main(HttpServletRequest request, HttpSession session, JspWriter out) throws Exception{
        ...
        try{
            ...
            Class homeInterface;
            try{
                homeInterface = Class.forName("org.apache.openejb.test.stateless.BasicStatelessHome",true, myLoader);
                out.println(OK);
            } catch (Exception e){
                out.println(FAIL);
                return;
            ...
            try{
                remoteInterface = Class.forName("org.apache.openejb.test.stateless.BasicStatelessObject",true, myLoader);
                out.println(OK);
            } catch (Exception e){
                out.println(FAIL);
                return;
