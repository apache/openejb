...
public class ConfigurationFactory implements OpenEjbConfigurationFactory, ProviderDefaults {
    ...
    protected static Logger logger = Logger.getInstance("OpenEJB", "org.apache.openejb.util.resources");
    protected static Messages messages = new Messages("org.apache.openejb.util.resources");
