 ...
 */
public abstract class AbstractEjbDeployment implements EjbDeployment, ExtendedEjbDeployment, J2EEManagedObject, GBeanLifecycle {
    ...
    public AbstractEjbDeployment(String containerId,
        ...
        if (TimedObject.class.isAssignableFrom(getBeanClass())) {
            ...
            if (timer != null) {
                timerService = new BasicTimerServiceImpl(this, ejbContainer, timer, kernel.getKernelName(), containerId);
            } else {
                timerService = null;
            }
        } else {
