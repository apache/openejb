...
**/
public class Resource implements java.io.Serializable, org.openejb.config.Service {
    ...
    **/
    ...
    public Resource() {
        super();
    } //-- org.openejb.config.sys.Resource()
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.sys.Resource unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.openejb.config.sys.Resource) Unmarshaller.unmarshal(org.openejb.config.sys.Resource.class, reader);
    } //-- org.openejb.config.sys.Resource unmarshal(java.io.Reader) 
