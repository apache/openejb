...
public class CmpFieldDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public CmpFieldDescriptor() {
        ...
        //-- _fieldName
        desc = new XMLFieldDescriptorImpl(java.lang.String.class, "_fieldName", "field-name", NodeType.Element);
        desc.setImmutable(true);
        handler = (new XMLFieldHandler() {
            public Object getValue( Object object ) 
                throws IllegalStateException
    ...
    } //-- org.openejb.config.ejb11.CmpFieldDescriptor()
    ...
    **/
    ...
    {
        return org.openejb.config.ejb11.CmpField.class;
