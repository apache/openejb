...
public class SecurityRole implements java.io.Serializable {
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.ejb11.SecurityRole unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (org.openejb.config.ejb11.SecurityRole) Unmarshaller.unmarshal(org.openejb.config.ejb11.SecurityRole.class, reader);
    } //-- org.openejb.config.ejb11.SecurityRole unmarshal(java.io.Reader) 
