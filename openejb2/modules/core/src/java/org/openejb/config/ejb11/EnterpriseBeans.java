...
public class EnterpriseBeans implements java.io.Serializable {
    ...
    **/
    public org.openejb.config.ejb11.EnterpriseBeansItem[] getEnterpriseBeansItem()
    {
        ...
        org.openejb.config.ejb11.EnterpriseBeansItem[] mArray = new EnterpriseBeansItem[size];
    ...
    **/
     ...
     * @param reader
    **/
    public static org.openejb.config.ejb11.EnterpriseBeans unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
    ...
    } //-- org.openejb.config.ejb11.EnterpriseBeans unmarshal(java.io.Reader) 
