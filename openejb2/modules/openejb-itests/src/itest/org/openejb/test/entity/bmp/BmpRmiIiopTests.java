...
/*-------------------------------------------------*/
    ...
    public void test41_returnEJBObject2() {
        try {
            ...
            RmiIiopBmpObject actual = (RmiIiopBmpObject) javax.rmi.PortableRemoteObject.narrow(ejbObject.returnEJBObject(), RmiIiopBmpObject.class);
            assertNotNull("The EJBObject returned is null", actual);
    ...
    public void test43_returnNestedEJBObject2() {
        try {
            ...
            //TODO: Put back
            //EncBmpObject actual = (EncBmpObject)(EncBmpObject)javax.rmi.PortableRemoteObject.narrow( graph.getObject(), EncBmpObject.class);
            RmiIiopBmpObject actual = (RmiIiopBmpObject) javax.rmi.PortableRemoteObject.narrow(graph.getObject(), RmiIiopBmpObject.class);
