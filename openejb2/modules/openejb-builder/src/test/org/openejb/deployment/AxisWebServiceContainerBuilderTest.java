...
public class AxisWebServiceContainerBuilderTest extends TestCase {
    ...
    public void XtestBuildGBeanData() throws Exception {
        ...
        GBeanData gBeanData = axisWebServiceContainerBuilder.buildGBeanData(sessionObjectName, null, "SimpleStatelessSession", serviceEndpointName, null, jarFile, classLoader, null);
