...
public class OpenOrbNameManglerTest extends TestCase {
    ...
    public void testHome() throws Exception {
        ...
        openOrbNameMangler.mapMethodNames(MockHome.class, MockHome.class.getClassLoader(), true);
    }

    public void testRemote() throws Exception {
        OpenOrbNameMangler openOrbNameMangler = new OpenOrbNameMangler();
        openOrbNameMangler.mapMethodNames(MockRemote.class, MockRemote.class.getClassLoader(), false);
    }
}
